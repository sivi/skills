#!/bin/bash
# submit-and-poll-prompt.sh — Submit via designs-from-prompt + poll + download
# Used by: generate-design (alternative mode) and composites that use prompt mode
#
# This is the CANONICAL single-design template for direct generation.
# Use this when the user wants to generate designs directly from a text prompt
# without copy review. Sivi generates and places text automatically.
#
...
data = {
    ...
    # Optional: free-form composition/layout/mood guidance.
